...
| --- | --- | --- | --- | --- |
| [`@hooksmith/aws`](https://jsr.io/@hooksmith/aws) | [![latest](https://jsr.io/badges/@hooksmith/aws)](https://jsr.io/@hooksmith/aws) | [![downloads](https://jsr.io/badges/@hooksmith/aws/total-downloads)](https://jsr.io/@hooksmith/aws) | [`hooksmith-aws`](https://github.com/Kralizek/hooksmith-aws) | AWS event adapters and service listeners for Hooksmith. |
| [`@hooksmith/aws-lambda`](https://jsr.io/@hooksmith/aws-lambda) | [![latest](https://jsr.io/badges/@hooksmith/aws-lambda)](https://jsr.io/@hooksmith/aws-lambda) | [![downloads](https://jsr.io/badges/@hooksmith/aws-lambda/total-downloads)](https://jsr.io/@hooksmith/aws-lambda) | [`hooksmith-aws`](https://github.com/Kralizek/hooksmith-aws) | AWS Lambda hosting support for Hooksmith runtimes. |
